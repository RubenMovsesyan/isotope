...
macro_rules! construct_render_pipeline {
    ($device:expr, $config:expr, $vertex_shader:expr, $fragment_shader:expr, $name:expr, $fill:expr, $buffers:expr, $( $layout:expr ),* ) => {
        {
            use wgpu::{
...
#[macro_export]
macro_rules! construct_debug_render_pipeline {
    ($device:expr, $config:expr, $vertex_shader:expr, $fragment_shader:expr, $name:expr, $fill:expr, $buffers:expr, $( $layout:expr ),* ) => {
        {
            use wgpu::{
                PipelineLayoutDescriptor, RenderPipelineDescriptor, VertexState, PipelineCompilationOptions, FragmentState, ColorTargetState,
